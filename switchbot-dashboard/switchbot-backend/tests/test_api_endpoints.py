...
from app.models import MeterDevice, MeterReading, TimeScale
from app.database import close_connection, init_database, save_reading_to_db
...
class TestRefreshMetersEndpoint:
    ...
    def test_refresh_meters_success(self, client, reset_data_store):
        with patch.object(switchbot_module, "SWITCHBOT_TOKEN", "test-token"), \
             ...
             patch("app.routes.meters.collect_data", new_callable=AsyncMock) as mock_collect:
