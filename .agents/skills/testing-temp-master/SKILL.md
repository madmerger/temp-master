...
The frontend build is served from `switchbot-frontend/dist/`, but locally this directory doesn't exist until
the frontend is built. Build it and create a symlink:
